...
void str_section() {
	switch (order.section) {
	case 1: {strcpy(string_section, "Канапе"); break; }
	case 2: {strcpy(string_section, "Ов.Зак."); break; }
	case 3: {strcpy(string_section, "Шашлики"); break; }
	}
}
...
void str_name() {
	...
	case 1: {
		switch (order.name) {
		case 1: {strcpy(string_name, "Із сиру"); order.price = 25; break; }
		case 2: {strcpy(string_name, "З шинкою"); order.price = 20; break; }
		case 3: {strcpy(string_name, "Із сьомги"); order.price = 35; break; }
		case 4: {strcpy(string_name, "З червоною ікр."); order.price = 55; break; }
		}
		break;
	}
	case 2: {
		switch (order.name) {
		case 1: {strcpy(string_name, "Шампіньони фарш"); order.price = 15; break; }
		case 2: {strcpy(string_name, "Рулетики із цук"); order.price = 12; break; }
		case 3: {strcpy(string_name, "Ассорті овочеве"); order.price = 10; break; }
		}
		break;
	}
	case 3: {
		switch (order.name) {
		case 1: {strcpy(string_name, "Рибні"); order.price = 40; break; }
		case 2: {strcpy(string_name, "М'ясні"); order.price = 45; break; }
		case 3: {strcpy(string_name, "Курині"); order.price = 35; break; }
		}
		break;
	}
	}
...
void str_service() {
	...
	{
	case 1: {strcpy(string_service, "Офіціанти"); break; }
	case 2: {strcpy(string_service, "Оренда"); break; }
	case 3: {strcpy(string_service, "Транспорт"); break; }
	case 4: {strcpy(string_service, "-"); break; }
	}
}
...
void overprice() {
	switch (order.service)
	{
	case 1: {order.price += order.price * 0.2; strcpy(order.overprice, "20%"); break; }
	case 2: {order.price += order.price * 0.3; strcpy(order.overprice, "30%"); break; }
	case 3: {order.price += order.price * 0.1; strcpy(order.overprice, "10%"); break; }
	case 4: {order.price += order.price * 0.05; strcpy(order.overprice, "5%"); break; }
	}
}
